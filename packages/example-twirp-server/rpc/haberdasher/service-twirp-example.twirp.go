...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "spec.haberdasher")
...
const HaberdasherPathPrefix = "/twirp/spec.haberdasher.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/spec.haberdasher.Haberdasher/MakeHat":
