...
export class DescriptorInfo implements IDescriptorInfo {
  ...
  isEnumField (fieldDescriptor: FieldDescriptorProto): boolean {
    ...
    if (typeof type != 'number') {
      type = FieldDescriptorProto_Type[type] as unknown as FieldDescriptorProto_Type
    }
    return type === FieldDescriptorProto_Type.ENUM;
  }
  ...
  getEnumFieldEnum (fieldDescriptor: FieldDescriptorProto): EnumDescriptorProto {
    ...
    if (type !== FieldDescriptorProto_Type.ENUM) {
  ...
  isMessageField (fieldDescriptor: FieldDescriptorProto): boolean {
    let type = fieldDescriptor.type
    if (typeof type != 'number' && type !== undefined) {
      type = FieldDescriptorProto_Type[type] as unknown as FieldDescriptorProto_Type
    }
    let msg = type === FieldDescriptorProto_Type.MESSAGE;
    if (!msg) {
      return false;
    }
  ...
  isGroupField (fieldDescriptor: FieldDescriptorProto): boolean {
    ...
    return type === FieldDescriptorProto_Type.GROUP;
  }
  ...
  getScalarFieldType (fieldDescriptor: FieldDescriptorProto): ScalarValueType {
    ...
    assert(type !== undefined);
    assert(type !== FieldDescriptorProto_Type.ENUM);
    assert(type !== FieldDescriptorProto_Type.MESSAGE);
    assert(type !== FieldDescriptorProto_Type.GROUP);
    assert(type !== FieldDescriptorProto_Type.UNSPECIFIED$);
    return type;
  }
  ...
  getMapKeyType (fieldDescriptor: FieldDescriptorProto): MapFieldKeyType {
    ...
    let type = keyField.type
    if (typeof type != 'number') {
      type = FieldDescriptorProto_Type[type] as unknown as MapFieldKeyType
    }
    assert(type !== FieldDescriptorProto_Type.UNSPECIFIED$, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.GROUP, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.MESSAGE, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.ENUM, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.FLOAT, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.DOUBLE, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    assert(type !== FieldDescriptorProto_Type.BYTES, `Unexpected map key type ${keyField?.type} for ${StringFormat.formatName(fieldDescriptor)}`);
    return type;
  }
  ...
  private getMapEntryMessage (fieldDescriptor: FieldDescriptorProto): DescriptorProto | undefined {
    ...
    if (type !== FieldDescriptorProto_Type.MESSAGE) {
      return undefined;
    }
  ...
  isUserDeclaredOptional (fieldDescriptor: FieldDescriptorProto): boolean {
    let label = fieldDescriptor.label
    assert(label !== undefined)
    if (typeof label != 'number') {
      label = FieldDescriptorProto_Label[label] as unknown as FieldDescriptorProto_Label
    }
    ...
    return label === FieldDescriptorProto_Label.OPTIONAL;
  }
  ...
  isUserDeclaredRepeated (fieldDescriptor: FieldDescriptorProto): boolean {
    ...
    if (label !== FieldDescriptorProto_Label.REPEATED) {
      return false;
    }
  ...
  shouldBePackedRepeated (fieldDescriptor: FieldDescriptorProto): boolean {
    ...
    if (type === FieldDescriptorProto_Type.BYTES || type === FieldDescriptorProto_Type.STRING) {
