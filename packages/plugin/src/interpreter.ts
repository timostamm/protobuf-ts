...
export class Interpreter {
  ...
  protected determineNonDefaultLongType (scalarType: rt.ScalarType, jsTypeOption?: FieldOptions_JSType): rt.LongType | undefined {
    ...
    if (jsTypeOption !== undefined) {
      if (typeof jsTypeOption != 'number') {
        jsTypeOption = FieldOptions_JSType[jsTypeOption] as unknown as FieldOptions_JSType
      }
      switch (jsTypeOption) {
  ...
  static isLongValueType (type: rt.ScalarType): boolean {
    if (typeof type != 'number') {
      type = rt.ScalarType[type] as unknown as rt.ScalarType
    }
    switch (type) {
 ...
 * compatible with enums generated by @chippercash/protobuf-plugin.
 */
