...
import type { EnumObjectValue } from "./enum-object";
import { isEnumObject } from ".";
...
export type EnumInfo = [
  ...
  /**
   * The enum mapping object generated by Typescript
   */
  {
    [key: number]: string;
...
function addEnumMappingToField (field: PartialFieldInfo): PartialFieldInfo {
  // If it's not an enum or has already been mapped just return the field.
